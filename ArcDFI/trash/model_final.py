...
import pickle
from demo08.trash.atom_extract_GCN import fusion_model as model_two
from utils.ID_Fusion import cross_attention
...
class fusion_model(nn.Module):
    def __init__(self, hidden1 = 256,attn_heads=1):
        ...
        self.DFI_feature = nn.ModuleList([nn.Linear(3200, 1024),nn.Linear(1024, 128)])
    ...
    def forward(self,dataset_batch):
        ...
        DF_Feature_two = self.model_two(dataset_batch)
